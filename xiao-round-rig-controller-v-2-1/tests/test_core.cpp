...
int main(){
 ...
 {GestureRecognizer r;r.sample(true,true,100,100,0);assert(r.sample(true,true,109,100,20).kind==TouchKind::Moved);}
 ...
 {GestureRecognizer r;r.sample(true,true,100,100,0,TouchZone::Category);assert(r.sample(true,true,100,100,1199).kind==TouchKind::None);assert(r.sample(true,true,100,100,1200).kind==TouchKind::HoldStarted);assert(r.sample(true,true,100,100,1250).kind==TouchKind::None);assert(r.sample(false,true,100,100,1260).kind==TouchKind::Released);}
 ...
 {GestureRecognizer r;r.sample(true,true,120,120,0,TouchZone::Center);assert(r.sample(true,true,120,120,1199).kind==TouchKind::None);assert(r.sample(true,true,120,120,1200).kind==TouchKind::HoldStarted);}
 {GestureRecognizer r;r.sample(true,true,10,10,0xfffffff0u);assert(r.sample(true,true,10,10,1184,TouchZone::Category).kind==TouchKind::HoldStarted);}
